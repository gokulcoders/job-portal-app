    ...
    <div className="hv-root">
      ...
      <section className="in-hero">
        <div className="in-hero-inner">
          ...
          <p>
            <strong>{total + featured.length}</strong> internship{(total + featured.length) !== 1 ? 's' : ''} available — real projects, real experience.
          </p>
        ...
        {error ? (
          ...
          <>
            <div className="in-results-head">
              <span className="in-count-badge">{total + featured.length}</span>
              internship{(total + featured.length) !== 1 ? 's' : ''} found
